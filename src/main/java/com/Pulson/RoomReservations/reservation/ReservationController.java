...
public class ReservationController {
    ...
    public ResponseEntity<List<MarkedReservation>> getAllActive() {
        return ResponseEntity.ok().body(readReservationMapper.mapToMarkedReservationsList(
    ...
    public ResponseEntity<List<ReservationReadDTO>> getUsersActiveReservations(@PathVariable("id") long id) {
        return ResponseEntity.ok().body(readReservationMapper.mapToReservationReadDTOsList(reservationService.getActiveByUser(id)));
    }
    ...
    public ResponseEntity<List<ReservationReadDTO>> getUsersReservationsHistory(@PathVariable("id") long id) {
        return ResponseEntity.ok().body(readReservationMapper.mapToReservationReadDTOsList
    ...
    public ResponseEntity<List<Integer>> getTodayReservationsStartingHoursByRoom(@PathVariable("year") int year, @PathVariable("month") int month,
        ...
        return ResponseEntity.ok().body(reservationService.getStartingHoursListByDateByRoom(year, month, day, roomId));
    }
    ...
    public ResponseEntity<List<MarkedReservation>> getReservationsByDate(@PathVariable("year") int year, @PathVariable("month") int month,
        ...
        return ResponseEntity.ok().body(readReservationMapper.mapToMarkedReservationsList(readReservationMapper.mapToReservationReadDTOsList(
    ...
    public ResponseEntity<Integer> getNumberOfReservationsPerDayPerUser(@PathVariable("year") int year, @PathVariable("month") int month,
        ...
        return ResponseEntity.ok().body(reservationService.getAmountByDateByUser(year, month, day, userId));
    }

    @PostMapping(value = "/add", consumes = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<String> create(@RequestBody ReservationCreateUpdateDTO reservationCreateUpdateDTO) {
        return ResponseEntity.ok().body(reservationService.create(createUpdateReservationMapper.mapToReservation(reservationCreateUpdateDTO)));
    }
